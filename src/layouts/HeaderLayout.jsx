...
import { connect, history, Link, SelectLang, useIntl } from 'umi'
...
const BasicLayout = (props) => {
  ...
  return (
    <ProLayout
      ...
      rightContentRender={() => {
        return isLogin ? <RightContent/> : <CustomerRightContent dispatch={dispatch}/>
      }}
...
const CustomerRightContent = ({ dispatch }) => {
